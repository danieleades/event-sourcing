//! Domain event marker.
//!
//! `DomainEvent` is the lightweight trait every concrete event struct implements.
//! It intentionally avoids persistence concerns; serialization is handled by
//! higher-level traits in the codec module.
